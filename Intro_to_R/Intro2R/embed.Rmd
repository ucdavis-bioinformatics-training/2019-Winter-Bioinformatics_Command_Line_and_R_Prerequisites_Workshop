...
#### `r colFmt("One useful function to find out information on a R object: str(). It compactly display the internal structure of a R object.", 'red')`  
...
For excample, we would like to calculate the sum of a column for every column in the matrix we created earlier. We are going to use *for* loop to do it.
